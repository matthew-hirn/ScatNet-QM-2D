% QM_REGRESSION_FOURIER_SAVE_NAME
...
function filename = qm_regression_fourier_save_name(data_opt, densities)

filename = strcat(data_opt.data_set, '_regression_fourier_N=', ...

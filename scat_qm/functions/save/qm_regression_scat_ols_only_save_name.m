% QM_REGRESSION_SCAT_OLS_ONLY_SAVE_NAME
% Create a file name for saving scattering regression computations that use
...
function filename = qm_regression_scat_ols_only_save_name(data_opt, scat_opt, filt_opt, densities)

filename = strcat(data_opt.data_set, '_regression_ols_only_scat_M=', ...
